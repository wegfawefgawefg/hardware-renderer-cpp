...
void VulkanRenderer::CreateLightPipeline()
{
    ...
    rasterization.lineWidth = m_supportsWideLines ? 2.5f : 1.0f;
...
void VulkanRenderer::CreateLightLinePipeline()
{
    m_lightLineFragShaderModule = CreateShaderModule(m_device, kLightLineFragShaderPath);
    ...
    CheckVk(
        vkCreateGraphicsPipelines(m_device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_lightLinePipeline),
        "vkCreateGraphicsPipelines(light lines)"
    );
}
...
void VulkanRenderer::CreateLightSolidPipeline()
{
    ...
    CheckVk(
        vkCreateGraphicsPipelines(m_device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_lightSolidPipeline),
        "vkCreateGraphicsPipelines(light solids)"
    );
}
